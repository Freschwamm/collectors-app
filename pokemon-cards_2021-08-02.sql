...
# Generation Time: 2021-08-02 12:36:21 +0000
# ************************************************************
...
LOCK TABLES `pokemon-cards` WRITE;
/*!40000 ALTER TABLE `pokemon-cards` DISABLE KEYS */;

INSERT INTO `pokemon-cards` (`id`, `Name`, `Cost`, `image`, `rarity`)
VALUES
...
/*!40000 ALTER TABLE `pokemon-cards` ENABLE KEYS */;
UNLOCK TABLES;
